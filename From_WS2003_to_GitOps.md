...
Back then, automation meant *a login script*, a `.bat` file, or a carefully crafted `.vbs` that ran at logon. You didn’t push code to production—you *RDPed* into production and clicked your way to glory (or disaster). And monitoring? That meant opening Event Viewer and hoping something jumped out before the phone rang.

But even in that era, patterns were forming: separation of concerns, centralized control, identity as the cornerstone of access. These core lessons never left me.
